...
public final class newjsp1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("//                $.ajax({\n");
      out.write("//                    type: \"POST\",\n");
      out.write("//                    url: \"form_registro.jsp\",\n");
      out.write("//                    success: function (msg) {\n");
      out.write("//                        $('#formularios').empty();\n");
      out.write("//                        $('#formularios').html(msg);\n");
      out.write("//                    }\n");
      out.write("//                });\n");
      out.write("//            }\n");
      out.write("//\n");
      out.write("//            function mostrarLogin() {\n");
      out.write("//                $.ajax({\n");
      out.write("//                    type: \"POST\",\n");
      out.write("//                    url: \"form_login.jsp\",\n");
      out.write("//                    success: function (msg) {\n");
      out.write("//                        $('#formularios').empty();\n");
      out.write("//                        $('#formularios').html(msg);\n");
      out.write("//                    }\n");
      ...
      out.write("                            <form id=\"uno\" action=\"Login\" name=\"nombre\" method=\"POST\">\n");
